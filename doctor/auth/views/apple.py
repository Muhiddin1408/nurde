...
class AppleOAuth2:
    ...
    def get_key_and_secret(self):
        kid = os.environ.get('DOCTOR_SOCIAL_AUTH_APPLE_KEY_ID')

        team_id = os.environ.get('USER_SOCIAL_AUTH_APPLE_TEAM_ID')

        client_id = os.environ.get('DOCTOR_SOCIAL_AUTH_APPLE_CLIENT_ID')

        private_key = open(os.environ.get('DOCTOR_SOCIAL_AUTH_APPLE_PRIVATE_KEY_USER'), 'rb').read()
        print(kid, 'kid')
        print(team_id, 'team')
        print(client_id)
        print(private_key)
